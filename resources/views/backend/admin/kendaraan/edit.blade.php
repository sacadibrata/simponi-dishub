                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Edit Jenis Kendaraan</li>
                            </ol>
                        </div>
                            ...
                            <form action="{{ route('kendaraan.update', $kendaraan->id) }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{ $kendaraan->jenis_kendaraan }}" name="jenis_kendaraan"  required>
                                    </div>
                                    <div class="col-lg-12">
