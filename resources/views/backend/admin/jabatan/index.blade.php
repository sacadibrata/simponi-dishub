                        ...
                        <div class="card-body">
                            ...
                            <div class="col-sm-12">
                                <div class="text-sm-end">
                                    <a href="{{ route('jabatan.create') }}" class="btn btn-primary mb-2"><i class="mdi mdi-plus-circle me-2"></i>Jabatan</a>
                                </div>
                            </div><!-- end col-->
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li>
                                                                <a href="{{ route('jabatan.edit', $item->id) }}" class="dropdown-item">
                                                                    <i class="uil-pen"></i>&nbsp;&nbsp;Edit
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="{{ route('jabatan.destroy', $item->id) }}" class="dropdown-item" data-confirm-delete="true">
